...
export const ContentArticle = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative flex items-center order-1",
      ...
      >
        ...
        <div className="relative  z-10 pl-18">
          ...
          <Link
            href={linkHref}
            className="inline-flex items-center text-yellow font-semibold hover:underline"
          >
      ...
      <div
        className={cn(
          "relative lg:w-2/3 order-2",
          reverse ? "lg:order-2 lg:ml-auto" : "lg:order-1",
        )}
      >
        <Image
